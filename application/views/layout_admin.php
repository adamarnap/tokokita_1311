      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li><a class="nav-link" href="<?= site_url('adminpanel/dashboard'); ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
            <li><a class="nav-link" href="<?= site_url('kategori'); ?>"><i class="fas fa-th"></i> <span>Kategori</span></a></li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="<?= site_url('ongkir'); ?>">Ongkos Kirim</a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="<?= site_url('member'); ?>"><i class="fas fa-users"></i> <span>Member</span></a></li>
            <li><a class="nav-link" href="<?= site_url('toko'); ?>"><i class="fas fa-store"></i> <span>Toko</span></a></li>
        </aside>
      </div>
