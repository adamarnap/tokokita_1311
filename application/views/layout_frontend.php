    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="<?= site_url('home'); ?>" class="navbar-brand sidebar-gone-hide">Tokokita</a>
                    ...
                    <div class="search-element">
                        <select data-width="150" class="form-control">
                            <?php foreach ($kategori as $val) { ?>
                                <option class="form-control"><?= $val->namaKat; ?></option>
                            <?php } ?>
                        </select>
                ...
                <?php if (!empty($this->session->userdata('id'))) { ?>
                    <a href="<?= site_url('home/member'); ?>" class="btn btn-outline-light">Menu Member</a>&nbsp; &nbsp; &nbsp;
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        <?php foreach ($kategori as $val) { ?>
                            <li class="nav-item">
                                <a href="#" class="nav-link"><span><?= $val->namaKat; ?></span></a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
